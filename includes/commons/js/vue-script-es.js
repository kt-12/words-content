...
Vue.component('kt12word-markup', {
    ...
    methods: {
        getWordContent: function getWordContent() {
            var _this = this;
...
var app = new Vue({
    ...
    computed: {
        sbBodyStyle: function sbBodyStyle() {
            return {
...
// jquery dependency
getTinymceContent = function getTinymceContent() {
...
externalSupport = function externalSupport() {
...
contactFormSupport = function contactFormSupport() {
